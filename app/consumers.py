...
class ScoreboardConsumer(AsyncWebsocketConsumer):
    ...
    async def time_new(self, event):
        print("Canal de comunicação do scoreboard: time.")
    ...
    async def penalties_new(self, event):
        print("Canal de comunicação do scoreboard: point.")
        match_data = event['match']
        await self.send(text_data=json.dumps({
            "type": "penalties",
            "data": match_data
    ...
    async def match_new(self, event):
        print("Canal de comunicação do scoreboard: match")
        match_data = event['match']
        await self.send(text_data=json.dumps({
            "type": "match",
            "data": match_data
    ...
    async def banner_new(self, event):
        print("Canal de comunicação do scoreboard: banner")
        match_data = event['match']
        await self.send(text_data=json.dumps({
            "type": "banner",
            "data": match_data
...
class PublicConsumer(AsyncWebsocketConsumer):
    ...
    async def match_update(self, event):
        print("Canal de comunicação: public.")
        match_data = event['match']
...
class AdminConsumer(AsyncWebsocketConsumer):
    ...
    async def match_update(self, event):
        print("Canal de comunicação: admin.")
        match_data = event['match']
        await self.send(text_data=json.dumps(match_data))